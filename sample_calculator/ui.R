    ...
    navbarPage(title='Sample Size Calculator',
               ...
               tabPanel(title="Introduction", 
                        wellPanel(
                          h3("Introduction"),
                          br(),
                          HTML(paste0("Hypothesis testing allows us to compare statistics between groups of data and determine if there is a significant difference or not. 
                            ...
                            ", "<br></br>", "Let's say we're evaluating the effectiveness of a new email marketing campaign for an e-commerce company. We want to conduct a hypothesis test to see if the click-through-rate (CTR) on a new version of an email advertisement is higher than the older version. 
                              We know that the current CTR is 10%. This is called the",  "<b>", " Baseline Probability", "</b>", ". Let's say we only care about a relative difference of 10% or more in CTR, i.e. any absolute change of 1 percentage point or higher is worth looking into. 
                              This is the ", "<b>", "Relative Minimum Detetctable Effect Size", "</b>", ". This value 
                              is decided based on context such that any smaller effect is considered negligible. Let's assume we also want a ", "<b>", "confidence level of 95%", "</b>",  " and ", "<b>", "power of 80%", "</b>", " on this test since this is conventional. 
                              ...
                              This is where a tool to calculate minimum required sample size comes in handy.", "<br></br>", "Use the next tab to try out these calculations yourself! First, think of a hypothesis test you'd like to conduct. Then, specify a baseline probability and minimum detectable effect size. 
                              Use the sliders to set the desired power and confidence level of your test and calculate the estimated sample size.", 
                                      "<br></br>", "Sometimes, the estimated sample size is too large or not feasible due to resource constraints. In such situations, it is good to know how you can change the required sample size by altering other parameters. 
